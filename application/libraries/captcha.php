...
class Captcha
{
	...
	public function main($config = array()) {
		...
		$captcha_config = array(
			...
			'min_length' => 5,
			'max_length' => 5,
			'png_backgrounds' => array(base_url('captcha/captcha_bg.png')),
			'fonts' => array(FCPATH.'captcha/times_new_yorker.ttf'),
		...
		// Generate image src
		$image_src = site_url('index.php/viewcaptcha').'?t=' . urlencode(microtime());
